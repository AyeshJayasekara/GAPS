...
/*!40000 ALTER TABLE `shipping_weight_index` DISABLE KEYS */;
INSERT INTO `shipping_weight_index` (`int_id`, `block_start`, `block_end`, `amount`)
VALUES (1, 0.000, 1000.000, 100.00),
       (2, 1001.000, 2000.000, 500.00),
       (3, 2001.000, 99999.000, 1000.00);
/*!40000 ALTER TABLE `shipping_weight_index` ENABLE KEYS */;
UNLOCK
    TABLES;
